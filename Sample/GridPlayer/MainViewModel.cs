...
namespace WpfApplication1.Controls.GridViewer
{
    ...
    public class MainViewModel : Observable
    {
        ...
        public IHelixViewport3D viewport;
        ...
        private  void FileOpen()
        {
            ...
            String strPath = this.fileDialogService.OpenFileDialog("models", null, OpenFileFilter, ".3ds");
            ReloadFile(strPath);
        ...
        public async void ReloadFile(String strPath)
        {
            this.CurrentModelPath = strPath;
            ...
            if (this.CurrentModel == null)
                ...
                this.CurrentModel.Children.Add(mFile);
            */
            //this.CurrentModel = await this.LoadAsync(this.CurrentModelPath, false);
            if (this.CurrentModel == null)
            {
            ...
            {
                Model3D mFile;
                mFile = await this.LoadAsync(this.CurrentModelPath, true);
